...
export default function ProjectCard(props) {
  ...
  return (
    <motion.div
      ...
      className="card overflow-hidden hover:-translate-y-0.5 hover:shadow-md transition-all duration-200"
    >
      ...
      <div className="p-5">
        <h3 className="font-bold text-slate-900 text-base leading-snug mb-2">{project.title}</h3>
